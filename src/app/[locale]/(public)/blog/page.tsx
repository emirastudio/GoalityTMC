...
async function getPublishedPosts(): Promise<BlogPostEntry[]> {
  try {
    ...
    return posts.map((p) => ({
      ...
      titleEn: p.titleEn,
      titleRu: p.titleRu,
      titleEt: (p as { titleEt?: string | null }).titleEt ?? null,
      titleEs: (p as { titleEs?: string | null }).titleEs ?? null,
      excerptEn: p.excerptEn,
      excerptRu: p.excerptRu,
      excerptEt: (p as { excerptEt?: string | null }).excerptEt ?? null,
      excerptEs: (p as { excerptEs?: string | null }).excerptEs ?? null,
