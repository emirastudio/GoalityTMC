...
export function DrawLanding({
  ...
  return (
    ...
    >
      ...
      {/* Header lives in PublicNavHeader one level up in the page
          composition — we skip the internal nav here to avoid two
          rows of chrome stacked on top of each other. */}
